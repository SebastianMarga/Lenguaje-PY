...
const formations = {
  "4-4-2": [
    // Portero
    { id: 1, name: "Portero", position: "GK", type: "goalkeeper", x: 50, y: 90 },

    // Defensores (ordenados de izquierda a derecha)
    { id: 2, name: "Lateral Izq", position: "LB", type: "defender", x: 15, y: 75 },
    { id: 3, name: "Central Izq", position: "CB", type: "defender", x: 35, y: 75 },
    { id: 4, name: "Central Der", position: "CB", type: "defender", x: 65, y: 75 },
    { id: 5, name: "Lateral Der", position: "RB", type: "defender", x: 85, y: 75 },

    // Mediocampistas (ordenados de izquierda a derecha)
    { id: 6, name: "Medio Izq", position: "LM", type: "midfielder", x: 15, y: 50 },
    { id: 7, name: "Medio Cen", position: "CM", type: "midfielder", x: 35, y: 50 },
    { id: 8, name: "Medio Cen", position: "CM", type: "midfielder", x: 65, y: 50 },
    { id: 9, name: "Medio Der", position: "RM", type: "midfielder", x: 85, y: 50 },

    // Delanteros (ordenados de izquierda a derecha)
    { id: 10, name: "Delantero", position: "ST", type: "forward", x: 35, y: 25 },
    { id: 11, name: "Delantero", position: "ST", type: "forward", x: 65, y: 25 },
  ],
  ...
  "4-3-3": [
    ...
    // Mediocampistas
    { id: 6, name: "Medio Def", position: "CDM", type: "midfielder", x: 50, y: 60 },
    { id: 7, name: "Medio Izq", position: "CM", type: "midfielder", x: 30, y: 45 },
    { id: 8, name: "Medio Der", position: "CM", type: "midfielder", x: 70, y: 45 },

    // Delanteros
    { id: 9, name: "Extremo Izq", position: "LW", type: "forward", x: 15, y: 25 },
    { id: 10, name: "Delantero", position: "ST", type: "forward", x: 50, y: 20 },
    { id: 11, name: "Extremo Der", position: "RW", type: "forward", x: 85, y: 25 },
  ],
  ...
  "4-2-3-1": [
    ...
    { id: 6, name: "Pivote Izq", position: "CDM", type: "midfielder", x: 35, y: 60 },
    { id: 7, name: "Pivote Der", position: "CDM", type: "midfielder", x: 65, y: 60 },

    // Mediocampistas ofensivos
    { id: 8, name: "Extremo Izq", position: "LM", type: "midfielder", x: 15, y: 40 },
    { id: 9, name: "Mediapunta", position: "CAM", type: "midfielder", x: 50, y: 35 },
    { id: 10, name: "Extremo Der", position: "RM", type: "midfielder", x: 85, y: 40 },

    // Delantero
    { id: 11, name: "Delantero", position: "ST", type: "forward", x: 50, y: 20 },
  ],
}
...
function changeFormation(formation) {
  ...
  instruction.textContent = "Haz clic en un jugador para seleccionarlo y luego en el campo para moverlo"
...
function selectPlayer(playerId) {
  ...
  playerElements.forEach((el) => {
    ...
    if (selectedPlayer && Number.parseInt(el.dataset.playerId) === selectedPlayer) {
